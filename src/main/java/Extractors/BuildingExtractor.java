...
public class BuildingExtractor {
    ...
    public static Building loadBuilding(CaseFile caseFile) {
        ...
        for (CaseFile.RoomData roomData : caseFile.getRooms()) {
            ...
            for (Map.Entry<String, String> neighborEntry : roomData.getNeighbors().entrySet()) {
                ...
                if (!VALID_DIRECTIONS.contains(direction)) {
                    System.out.println("Invalid direction '" + direction + "' for room '" + roomData.getName() + "'. Skipping.");
                    hasErrors = true; // Mark that there was an error
                ...
                if (neighbor != null) {
                    ...
                    System.out.println("Neighbor room '" + neighborName + "' not found for room '" + roomData.getName() + "'. Skipping.");
                    hasErrors = true; // Mark that there was an error
                }
            }
        }
        ...
        if (hasErrors) {
            System.out.println("Errors encountered while loading the case. Exiting to case selection menu.");
            return null;
        }
        ...
        if (startingRoom == null) {
            System.out.println("Starting room '" + caseFile.getStartingRoom() + "' not found. Exiting to case selection menu.");
            return null;
        }
